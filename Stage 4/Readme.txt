...
To compile and run the program, either open the TerminalTicketingGUI folder as a java NetBeans project and run the Main.java class file, or:
...
How to run-- Either run the distributed jar file found in the TerminalTicketingGUI/dist folder (through the java -jar command or simply by double clicking the executable), or run the compiled classes from the previous step.
